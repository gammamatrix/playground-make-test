...
/**
 * \Tests\Feature\Playground\Make\Test\Console\Commands\TestMakeCommand\ApiTest
 */
#[CoversClass(TestMakeCommand::class)]
class ApiTest extends TestCase
{
    public function test_command_make_playground_api_tests_without_model_file_and_fail(): void
    {
        ...
        $command = sprintf(
            ...
            $this->getResourceFile('playground-api')
        );
        // dump($command);
    ...
    public function test_command_make_playground_api_tests_with_force_without_skeleton(): void
    {
        $command = sprintf(
    ...
    public function test_command_make_playground_api_tests_without_force_with_file_without_skeleton(): void
    {
        $command = sprintf(
    ...
    public function test_command_make_playground_api_tests_with_force_with_file_with_skeleton(): void
    {
        $command = sprintf(
    ...
    public function test_command_make_playground_api_tests_with_force_with_model_in_file_with_skeleton(): void
    {
        $command = sprintf(
            'playground:make:test --skeleton --force --file %1$s',
            $this->getResourceFile('playground-api-with-model'),
        );
        // dump($command);
        // $result = $this->withoutMockingConsoleOutput()->artisan($command);
        // dump(Artisan::output());
